...
export class Backend implements backendInterface {
    ...
    async getAllPreferences(): Promise<Array<Preferences>> {
    ...
    async updatePreferences(arg0: string, arg1: bigint, arg2: bigint, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePreferences(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
